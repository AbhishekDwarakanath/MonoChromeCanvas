...
public class ContactHelper {
    ...
    static ArrayList<Contact> listContacts1 = new ArrayList<>();

    public static ArrayList<Contact> getContactCursor(ContentResolver contactHelper,
                                                      String startsWith) {
        ...
        try {
            ...
            if (cur.moveToFirst()) {
                ...
                do {
                    String contactId = cur.getString(idIndex);
                    String contactDisplayName = cur.getString(nameIndex);
